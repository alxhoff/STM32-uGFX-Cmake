...
IF(NOT STM32_TARGET)
    MESSAGE(STATUS "No STM32_TARGET specified, trying to get it from STM32_CHIP")
    IF(NOT STM32_CHIP)
        SET(STM32_TARGET "F429" CACHE INTERNAL "stm32 target")
        MESSAGE(STATUS "Neither STM32_TARGET nor STM32_CHIP specified, using default STM32_TARGET: ${STM32_FAMILY}")
    ELSE()
        STRING(REGEX REPLACE "^(([sS][tT][mM]32[fF][0-47]+.)).+$" "\\1" STM32_TARGET ${STM32_CHIP})
        STRING(TOUPPER ${STM32_TARGET} STM32_TARGET)
        MESSAGE(STATUS "Selected STM32 target: ${STM32_TARGET}")
    ENDIF()
ENDIF()
